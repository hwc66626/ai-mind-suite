...
GATES = ("task_start", "before_answer", "before_commit",
         "before_delete", "before_finish", "task_end", "any")
...
# ---------------- 承诺看门狗（防"答应即终止"） ----------------
PROMISE_RENAG_MIN = 15              # 承诺到期未兑现的重叩间隔（分钟）
...
PRESETS = {
    ...
    "before_finish": [
        ("我答应过的事都做完了吗？还是只把'好的我马上做'说出口了？", "承诺兑现"),
        ("声称完成的每一项，证据在哪？（命令输出/文件存在/测试通过）", "证据验收"),
        ("待办清单上还有没有'差不多就这样'糊弄过去的项目？", "进度诚实"),
    ],
}
